...
def File.blocks(filename)
end

def File.blksize(filename)
end
...
def File.uid(filename)
end

def File.gid(filename)
end
...
#
def File.chmod(mode_int,filename, *args)
  NoMethodError.abstract(self)
end
...
#   File.chmod(0644, "testfile", "out")   #=> 2
#
def File.lchmod(mode_int, *filenames)
  NoMethodError.abstract(self)
end
...
#
def File.chown(owner_id, group_id, *filenames)
  NoMethodError.abstract(self)
end
...
#
def File.link(old_name, new_name)
  NoMethodError.abstract(self)
end
...
#
def File.symlink(old_name, new_name)
  NoMethodError.abstract(self)
end
...
#
def File.utime(atime, mtime, *filenames)
  NoMethodError.abstract(self)
end
...
#
def File.expand_path(filename, dir_string=nil)
  NoMethodError.abstract(self)
end
...
#
def File.absolute_path(filename, dir_string=nil)
  NoMethodError.abstract(self)
end
...
#
def File.realpath(pathname, dir_string=nil)
  NoMethodError.abstract(self)
end
...
#
def File.realdirpath(pathname, dir_string=nil)
  NoMethodError.abstract(self)
end
...
#
def File.basename(filename, suffix=nil)
  NoMethodError.abstract(self)
end
...
#   File.size("out")          #=> 5
#
def File.truncate(filename, bytes)
  NoMethodError.abstract(self)
end
